...
public class Scraping {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String next_url="https://www.champssports.com/_-_/keyword-air+jordan+shoes?cm_PAGE=180&Rpp=180&Ns=P_NewArrivalDateEpoch%7C1";
		...
		for(String link:links) {
			...
			String price=driver.findElement(By.cssSelector("#product_form > div.pdp_wrapper > div.top_wrapper > div.product_content > span.right_column > div.product_info > div.product_price > div > span.value")).getText();
